...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("can0_start_id", default_value="1"),
        DeclareLaunchArgument("can1_start_id", default_value="1"),
        DeclareLaunchArgument("can2_start_id", default_value="1"),
        DeclareLaunchArgument("can3_start_id", default_value="1"),
        DeclareLaunchArgument("can0_motor_count", default_value="5"),
        DeclareLaunchArgument("can1_motor_count", default_value="5"),
        DeclareLaunchArgument("can2_motor_count", default_value="5"),
        DeclareLaunchArgument("can3_motor_count", default_value="5"),
        DeclareLaunchArgument("can0_joint_dirs", default_value="[1, 1, 1, 1, 1]"),
        DeclareLaunchArgument("can1_joint_dirs", default_value="[1, 1, 1, 1, 1]"),
        DeclareLaunchArgument("can2_joint_dirs", default_value="[1, 1, 1, 1, 1]"),
        DeclareLaunchArgument("can3_joint_dirs", default_value="[1, 1, 1, 1, 1]"),
        DeclareLaunchArgument("can0_motor_types", default_value="encos,dm,dm,encos,dm"),
        DeclareLaunchArgument("can1_motor_types", default_value="encos,dm,dm,encos,dm"),
        DeclareLaunchArgument("can2_motor_types", default_value="encos,dm,dm,encos,dm"),
        DeclareLaunchArgument("can3_motor_types", default_value="encos,dm,dm,encos,dm"),
        node_MotCtrl,
    ])
